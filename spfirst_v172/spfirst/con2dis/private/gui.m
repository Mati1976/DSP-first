...
h0 = figure('Units','normalized', ...
	...
	'RendererMode','manual', ...
	'Tag','con2dis', ... %'ToolBar','none',...
	'NumberTitle','off');

if MATLABVERSION < 8.4
    set(h0,'DoubleBuffer','on');
end
set(h0,'ResizeFcn','con2dis ResizeFcn');

b = uimenu('Parent',h0, ...
    'Label','&File', ...
    'Tag','File');
b1 = uimenu('Parent',b, ...
    'Callback','con2dis Screenshot', ...
    'Label','&Take Screen-shot...','Tag','Screenshot');
b2 = uimenu('Parent',b, ...
    'Callback','con2dis ShowMenu', ...
    'Label','&Show Menu','Tag','ShowMenu');
b3 = uimenu('Parent',b, ...
    'Callback','close', ...
    'Label','&Exit','Tag','Exit');
